...
def forget_pass():
    ...
    imagebg=ImageTk.PhotoImage(file='Pic1.jpg')    
...
usernameEntry.place(x=220,y=110)
...
forgetbutton.place(x=220,y=200)

#Login button 

loginButton=Button(login_window,text='Login',bg='AntiqueWhite', fg='Black',font=('Cambria',15,'bold'),bd=0,cursor='hand2',height=2,width=15,activebackground='gold',command=login)
